import { AiScanIcon, Facebook01Icon, GoogleIcon } from 'hugeicons-react'
        ...
        <>
            <motion.div variants={container} initial="hidden" animate="visible" className='w-full h-full flex gap-6 flex-col justify-center items-center'>
                ...
                <motion.div className='flex flex-col justify-center items-center gap-1' variants={item}>
                    <motion.h1 variants={item} className='text-xl font-bold font-info' style={{ color: COLORS.PURPLE }}> Connexion</motion.h1>
                ...
                <motion.div variants={item} className='w-[90%] flex flex-col gap-4'>
                    ...
                    <motion.div variants={item} className='w-full flex flex-col gap-2'>
                        <button className='mt-8 h-12 rounded-lg font-medium text-md font-body text-white' style={{ backgroundColor: COLORS.PURPLE }}>Se connecter</button>
                        <Link to="auth/signup" className='text-center text-gray-600 font-body'>Vous n'avez pas de compte ? <span className='underline' style={{ color: COLORS.PURPLE }}>Inscrivez-vous</span> </Link>
                    </motion.div>
                </motion.div>
